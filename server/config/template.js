...
exports.merchantSignup = (host, { resetToken, email }) => {
  const message = {
    ...
    text: `${
      'Congratulations! Your application has been accepted. Please complete your Vendor account signup by clicking on the link below. \n\n' +
      'Please click on the following link, or paste this into your browser to complete the process:\n\n' +
      'http://'
...
exports.merchantWelcome = name => {
  const message = {
    subject: 'Vendor Registration',
    text:
      `Hi ${name}! Congratulations! Your application for Vendor account has been accepted. \n\n` +
...
exports.orderConfirmationEmail = order => {
  const message = {
    ...
    text:
      ...
      `We've received your order and will contact you as soon as your package is Processed. \n\n`
  };
